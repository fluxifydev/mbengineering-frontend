...
export default function ContactClient() {
  ...
  return (
    <>
      <Header onRequestQuote={() => handleOpenQuote('Contact Page Inquiry')} />

      <main className="pt-20">
        <div className="bg-surface py-6 px-margin-mobile md:px-margin-desktop max-w-[1440px] mx-auto">
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-primary tracking-tight">Contact Us</h1>
          <p className="text-on-surface-variant mt-2 text-sm sm:text-base">Get in touch with our engineering team for custom consultations and quotes.</p>
        </div>
