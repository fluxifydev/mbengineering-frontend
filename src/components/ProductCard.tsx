...
export default function ProductCard({ product, onRequestQuote }: ProductCardProps) {
  ...
  return (
    <div 
      ...
      className="bg-white rounded-xl border border-outline-variant/60 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 w-full flex flex-col justify-between h-[410px] sm:h-[430px] lg:h-[450px] cursor-pointer group hover:border-primary/55 select-none"
    >
      {/* Media container */}
